...
def flow_entry(flow: mitmproxy.http.HTTPFlow) -> dict:
    ...
    if flow.server_conn and flow.server_conn not in SERVERS_SEEN:
        # I'm running in upstream mode, and this script crashed because
        # `flow.server_conn.timestamp_tcp_setup` was null. I'm not sure if it's
        # a bug present in all modes, of if it's unique to upstream mode. In
        # any case, I'm thinking that it's OK to default it to
